...
namespace passion__project.Controllers
{
    public class AlbumController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,AlbumName,Rating,ArtistID")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,AlbumName,Rating,ArtistID")] Album album)
        {
            if (ModelState.IsValid)
            {
